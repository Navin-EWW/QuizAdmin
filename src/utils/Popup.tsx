              ...
              <Dialog.Panel className="relative rounded-md  transform overflow-hidden bg-white  text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[480px] px-8 sm:px-10  py-8 sm:py-8">
                ...
                <div className="">
                  <div className=" sm:mt-0 text-left">
                    <Dialog.Title
                      as="h3"
                      className="text-[18px] font-Inter font-bold uppercase text-font_black"
                    >
                      {header}
                    </Dialog.Title>
                    {subHeader && (
                ...
                <div className="sm:mt-2 sm:flex gap-3 gap-y-2">
                  {buttonlevelblue && (
                    <button
                      ...
                      className={`inline-flex w-full rounded-md justify-center border border-transparent ${
                        deleteId
                          ? "bg-error_red hover:bg-Incative_red"
                          : "bg-blue_primary hover:bg-hoverChange"
                      } px-4 py-2 text-sm font-Inter font-normal text-white shadow-sm focus:outline-none`}
                      onClick={() => {
                        onSubmit(() => {});
                      }}
                    >
                      {isLoading ? <ButtonSpinner /> : buttonlevelblue}
                      {/* {t("LogOut.OK")} */}
                    </button>
                  )}
                  ...
                  {buttonlevelwhite && (
                    <button
                      type="button"
                      className="mt-3 inline-flex w-full rounded-md justify-center border border-grey_border bg-white hover:bg-grey_bg px-4 py-2 text-sm font-Inter font-normal text-font_dark shadow focus:outline-none sm:mt-0"

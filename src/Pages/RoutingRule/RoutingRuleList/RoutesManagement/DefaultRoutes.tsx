...
interface props {
  editCnt: boolean;
  refechstate: boolean;
  customerBookingListData: routingRuleType[];
  setOldCustomerBookingListData: any;
  setCustomerBookingListData: any;
  seteditCnt: React.Dispatch<boolean>;
  filterOriginDestiion: originDestionType | undefined;
  // refechData: (value:any)=>void;
  refetchTheDefaultRoutesData: boolean;
  oldCustomerBookingListData: routingRuleType[];
  tabRedirect: boolean;
}
...
function DefaultRoutes({
  editCnt,
  tabRedirect,
  refetchTheDefaultRoutesData,
  seteditCnt,
  setOldCustomerBookingListData,
  setCustomerBookingListData,
  ...
  const { error, isFetching, isError, isLoading, refetch } = useQuery(
      ...
      }),
    {
      ...
      onSuccess(data) {
        if (data.status) {
          setOldCustomerBookingListData(data?.data);
  ...
  const defaultValues = () => {
    setCustomerBookingListData(oldCustomerBookingListData);
  };

  const onChangeCustomerBookingListData = (
    index: number,
    id: string,
    value: string
  ) => {
    ...
    for (let [i, a] of customerBookingListData?.entries()) {
      let tempObj = a;
      if (i === index) {
        tempObj = { ...a, id: id, routingRuleId: value };
      }
      data?.push(tempObj);
    }

    setCustomerBookingListData(data);
  };
  ...
  const handleSelectMode = (value: any) => {
    ...
    editCnt && setCustomerModeOpen(true);
    setcurrent_page(1);
  };
  ...
  const handleSelectFirst_Mile = (value: any) => {
    ...
    editCnt && setCustomerFirst_MileOpen(true);
    setcurrent_page(1);
  };
  ...
  const handleSelectInt_Mile = (value: any) => {
    ...
    editCnt && setCustomerInt_MileOpen(true);
    setcurrent_page(1);
  };
  ...
  const handleSelectLast_Mile = (value: any) => {
    ...
    editCnt && setCustomerLast_MileOpen(true);
    setcurrent_page(1);
  };
  ...
  const handleSelectExport_Custom = (value: any) => {
    ...
    editCnt && setCustomerExport_CustomOpen(true);
    setcurrent_page(1);
  };
  ...
  const handleSelectImport_Custom = (value: any) => {
    ...
    editCnt && setCustomerImport_CustomOpen(true);
    setcurrent_page(1);
  };
              ...
              <tr>
                ...
                >
                  <div className="flex items-center gap-2 min-w-[142px] w-[142px] pb-2">
                    ...
                    <span>
                      <a
                        className="cursor-pointer"
                        onClick={() => !editCnt && onSort("transportationMode")}
                      >
                  ...
                  <ModeSelecter
                    ...
                    isOpen={!editCnt ? CustomerModeOpen : false}
                  ...
                  <div>
                    <div className="flex items-center gap-2 min-w-[125px] w-[125px] pb-2">
                      ...
                      <span>
                        <a
                          className="cursor-pointer"
                          onClick={() => !editCnt && onSort("productType")}
                        >
                          {sortBy === "productType" ? (
                            sortType === "asc" ? (
                              <img src={DownArrow} />
                ...
                >
                  <div className="flex items-center gap-2 pb-2">
                    ...
                    <span>
                      <a
                        className="cursor-pointer"
                        onClick={() =>
                          !editCnt && onSort("firstMileServiceSupplier")
                        }
                      >
                  ...
                  <FirstMileSelector
                    ...
                    isOpen={!editCnt ? CustomerFirst_MileOpen : false}
                ...
                >
                  <div className="flex items-center gap-2 pb-2">
                    ...
                    <span>
                      <a
                        className="cursor-pointer"
                        onClick={() =>
                          !editCnt && onSort("internationalMileServiceSupplier")
                        }
                      >
                  ...
                  <InternationalMileSelector
                    ...
                    isOpen={!editCnt ? CustomerInt_MileOpen : false}
                ...
                >
                  <div className="flex items-center gap-2 pb-2">
                    ...
                    <span>
                      <a
                        className="cursor-pointer"
                        onClick={() =>
                          !editCnt && onSort("lastMileServiceSupplier")
                        }
                      >
                  ...
                  <LastMileSelector
                    ...
                    isOpen={!editCnt ? CustomerLast_MileOpen : false}
                ...
                >
                  <div className="flex items-center gap-2 pb-2">
                    ...
                    <span>
                      <a
                        className="cursor-pointer"
                        onClick={() =>
                          !editCnt && onSort("exportCustomerClearenceSupplier")
                        }
                      >
                  ...
                  <LastMileSelector
                    ...
                    isOpen={!editCnt ? CustomerExport_CustomOpen : false}
                ...
                >
                  <div className="flex items-center gap-2 pb-2">
                    ...
                    <span>
                      <a
                        className="cursor-pointer"
                        onClick={() =>
                          !editCnt && onSort("importCustomerClearenceSupplier")
                        }
                      >
                  ...
                  <LastMileSelector
                    ...
                    isOpen={!editCnt ? CustomerImport_CustomOpen : false}
                ...
                <th
                  scope="col"
                  className="px-6 bg-grey_bg py-3.5 text-left text-xs font-medium sticky -right-[1px] w-full"
                >
                  ...
                  <tr key={index}>
                    ...
                    {!editCnt ? (
                      ...
                      <td className="whitespace-nowrap px-6 py-3 lg:table-cell">
                        <div className="mt-1 sm:col-span-2 sm:mt-0 w-full sm:max-w-xs">
                          <select
                            disabled={order?.master}
                            id="routingRuleId"
                            name="routingRuleId"
                            defaultValue={order?.routingRuleId}
                            onChange={(e: any) =>
                              onChangeCustomerBookingListData(
                                index,
                                e?.target?.value.split(" ")[0],
                                e?.target?.value.split(" ")[1]
                              )
                            }
                            className="block w-full max-w-lg rounded-md border font-normal border-grey_border_table  focus:border-blue_primary active:border-blue_primary focus:text-font_black focus:outline-none sm:max-w-xs py-2 px-3 text-sm"
                          >
                            {[
                              {
                                code: oldCustomerBookingListData[index]
                                  ?.routingRuleId,
                                id: oldCustomerBookingListData[index]?.id,
                              },
                              ...oldCustomerBookingListData[index]?.backupRule,
                            ]?.map((x: any) => {
                              return (
                                <option
                                  value={`${x?.id?.trim()} ${x?.code?.trim()}`}
                                >
                                  {x?.code}
                                </option>
                              );
                    ...
                    <td className="whitespace-nowrap px-6 py-4 sm:table-cell">
                      <span
                        className={`${
                          order.pickup
                            ? "text-font_green bg-light_geen rounded-full px-6 py-1 text-xs font-medium cursor-pointer"
                            : order?.pickup === null
                            ? "text-font_black bg-white"
                            : "text-Incative_red bg-light_red rounded-full px-6 py-1 text-xs font-medium cursor-pointer"
                        } `}
                      >
                        {order.pickup
                          ? "True"
                    ...
                    <td className="whitespace-nowrap text-blue_primary text-sm font-medium text-right sticky right-0 p-0 w-full">
                      <p

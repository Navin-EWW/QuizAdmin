...
export default function ShipmentStage(prop: Props) {
  const {
    selectedValue = [],
    AllData = [],
    isOpen,
  ...
  const handleClickOutside = (event: any) => {
    if (
      event.target.closest("#list-box-ShipmentStage, #list-btn-ShipmentStage")
    )
      return;
    else {
      setIsOpen(false);
  ...
  return (
    <div>
      ...
      >
        {() => (
          <>
            <span className="inline-block w-full" id="list-btn-ShipmentStage">
              <Listbox.Button
            ...
            >
              <div id="list-box-ShipmentStage" className="border-grey_border">

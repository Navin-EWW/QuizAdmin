...
export default function InternalStatusSelecter(prop: Props) {
  const {
    selectedValue = [],
    AllData = [],
    isOpen,
  ...
  const handleClickOutside = (event: any) => {
    if (event.target.closest("#list-box-internal, #list_btn-internal")) return;
    else {
      setIsOpen(false);
    }
  };
  ...
  return (
    <div>
      ...
      >
        {() => (
          <>
            <span className="inline-block w-full" id="list_btn-internal">
              <Listbox.Button
            ...
            >
              <div id="list-box-internal" className="border-grey_border">

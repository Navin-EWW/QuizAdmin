      ...
      <div className="text-sm sm:grid sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 sm:items-center items-start sm:gap-4 sm:border-t border-grey_border_table sm:pt-5">
        ...
        >
          <input
            ...
            className={
              editCnt
                ? `block pr-10 w-full max-w-lg disabled:bg-grey_color rounded-md font-normal bg-transparent focus:text-font_black focus:outline-none sm:max-w-xs py-2 px-3 text-sm ${
                    !disabled ? "text-table_head_color" : ""
                  }`
                : `block rounded-md w-full border font-normal ${
                  ...
                  } py-2 px-3 text-sm ${disabled ? "text-table_head_color" : ""}`
            }
          />
          {errorStatus && (

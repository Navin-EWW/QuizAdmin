    ...
    <div className="text-sm sm:grid sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 sm:items-center items-start sm:gap-4 sm:border-t border-grey_border_table sm:pt-5">
      ...
      <div className="relative mt-1 sm:col-span-2 sm:mt-0 rounded-md sm:max-w-xs max-w-lg w-full">
        <PatternFormat
          ...
          className={
            editCnt
              ? `block w-full max-w-lg rounded-md font-normal bg-transparent focus:text-font_black focus:outline-none sm:max-w-xs py-2 px-3 text-sm text-table_head_color`
              : `block w-full max-w-lg rounded-md border font-normal ${
                ...
                } focus:text-font_black focus:outline-none sm:max-w-xs py-2 pr-10  px-3 text-sm text-table_head_color`
          }
        />
        {errorStatus && (
...
export default PhoneNumberFormatInput;
